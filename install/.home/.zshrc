...
dirhistory eza git fzf kube-ps1 kubectl helm rsync snap ssh sudo symfony6 taskwarrior tig tmux tmuxinator z zsh-autosuggestions zsh-syntax-highlighting)
