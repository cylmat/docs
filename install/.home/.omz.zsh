...
# Overrided in .zshrc
# no "vi-mode" to keep default zsh shortcuts
...
kube-ps1 kubectl helm rsync ssh sudo symfony6 tig tldr tmux tmuxinator z zsh-autosuggestions zsh-navigation-tools zsh-syntax-highlighting)
